      ...
      <div class="card" id="contenido" >
        <h2>Informacion personal</h2>
          ...
          <?php foreach($listado as $fila){ ?>
            ...
            <input name="tel_persona"  type="text" value="<?php echo utf8_encode($fila['tel_persona']) ?>"> <br><br>
            <label>Email</label>
            <input name="email_persona"  type="text" value="<?php echo utf8_encode($fila['email_persona']) ?>">  <br><br>
            <label>Usuario</label>
